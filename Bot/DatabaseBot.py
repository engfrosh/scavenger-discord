"""Nextcord Bot Client with a Database Connection"""
...
logger = logging.getLogger("DatabaseBot")
...
class DatabaseBot(commands.Bot):
    """Nextcord Bot Client with database support."""

    def __init__(self, command_prefix: str, db_engine: sqlalchemy.engine.Engine,
